...
export const components: ComponentDefinition[] = [
  {
    ...
    relationships: [
      ...
      'Produces training-ready datasets for SDG Hub and Training Hub workflows',
  ...
  },
  {
    ...
    relationships: [
      ...
      'SDG Hub generates synthetic evaluation datasets for RAG quality testing',
    ],
  },
  {
    id: 4,
    ...
    relationships: [
      ...
      'Validates models produced by Training Hub and AutoML',
      'Consumes synthetic evaluation datasets generated by SDG Hub',
    ],
  },
  {
    id: 5,
    ...
    relationships: [
      ...
      'Produces fine-tuning data used by Training Hub workflows',
  ...
  },
  {
    ...
    demoStatus: 'coming-soon',
    relationships: [
      'Consumes synthetic training data generated by SDG Hub',
      'Trained models are validated and benchmarked by Eval Hub',
      'Fine-tuned models can leverage ITS Hub for enhanced inference',
    ],
  },
  {
    id: 7,
    ...
    demoStatus: 'live',
    relationships: [
      'Enhances output quality of models fine-tuned by Training Hub',
